...
ENTRIES = [
    ('2026-09-26', 'ブログ', '記事「文字が一瞬あとから出る — ウェブフォントをやめた話」を公開しました。'),
    ('2026-09-23', 'ブログ', '記事「スマホのバックアップに入らないもの — 復元してから気づく前に」を公開しました。'),
    ('2026-09-22', 'ブログ', '記事「SSDは容量だけで選ばない — カタログの速度が出ない理由」を公開しました。'),
    ('2026-09-21', 'ブログ', '記事「タブを閉じても残るもの — ブラウザに溜まる記録を整理する」を公開しました。'),
    ('2026-09-18', 'ブログ', '記事「USB-Cケーブルは見た目で選べない — 端子が同じでも中身が違う」を公開しました。'),
    ('2026-09-17', 'ブログ', '記事「パスワードマネージャーの選び方 - 何を預けることになるのか」を公開しました。'),
    ('2026-09-02', 'ブログ', '記事「144Hzで何が変わるのか — 遅延はどこで積まれているか」を公開しました。'),
